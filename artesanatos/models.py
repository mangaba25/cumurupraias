...
class Artesanato(models.Model):
    ...
    image_5 = models.ImageField(upload_to='artesanatos', verbose_name='Imagem_5', null=True, blank=True)
    decription_5 = models.CharField('Descrição-5', max_length=100, blank=True)
    image_6 = models.ImageField(upload_to='artesanatos', verbose_name='Imagem_6', null=True, blank=True)
    decription_6 = models.CharField('Descrição-6', max_length=100, blank=True)
    image_7 = models.ImageField(upload_to='artesanatos', verbose_name='Imagem_7', null=True, blank=True)
    decription_7 = models.CharField('Descrição-7', max_length=100, blank=True)
    image_8 = models.ImageField(upload_to='artesanatos', verbose_name='Imagem_8', null=True, blank=True)
    decription_8 = models.CharField('Descrição-8', max_length=100, blank=True)
    image_9 = models.ImageField(upload_to='artesanatos', verbose_name='Imagem_9', null=True, blank=True)
    decription_9 = models.CharField('Descrição-9', max_length=100, blank=True)
    image_10 = models.ImageField(upload_to='artesanatos', verbose_name='Imagem_10', null=True, blank=True)
